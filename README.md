...
```shell
opctl op install github.com/opspec-pkgs/_.op.bootstrap#2.1.0
```

## Run

```
opctl run github.com/opspec-pkgs/_.op.bootstrap#2.1.0
```
...
```yaml
op:
  ref: github.com/opspec-pkgs/_.op.bootstrap#2.1.0
  inputs:
    # params w/ default
    srcDir:
  outputs:
