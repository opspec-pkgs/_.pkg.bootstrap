[![Build Status](https://github.com/opspec-pkgs/_.op.bootstrap/workflows/push/badge.svg?branch=master)](https://github.com/opspec-pkgs/_.op.bootstrap/actions?query=workflow%3ABuild+branch%3Amaster)
